...
<f:view>
	...
	<td>
		...
		<table style="width: 402px;" align="right">
			<tr>
			...
			<tr>
				<td><h:outputText value="System Size (KWh):"></h:outputText></td>
				<td><h:inputText value="#{equipment.size}"></h:inputText></td>
			</tr>
			<tr>
				<td><h:outputText value="Inverter Efficiency (%):"></h:outputText></td>
		...
		<fieldset>
			...
			<table style="width: 402px;" align="center">
				<tr>
					<td><h:outputText value="Percentage on North Roof:"></h:outputText></td>
					<td><h:inputText value="#{roof.percentageNorth}"></h:inputText></td>
				</tr>
				<tr>
					<td><h:outputText value="Percentage on West Roof:"></h:outputText></td>
					<td><h:inputText value="#{roof.percentageWest}"></h:inputText></td>
				</tr>
				<tr>
					<td><h:outputText value="Efficiency Loss (North Roof):"></h:outputText></td>
					<td><h:inputText value="#{roof.efficiencyLossNorth}"></h:inputText></td>
				</tr>
				<tr>
					<td><h:outputText value="Efficiency Loss (West Roof):"></h:outputText></td>
		...
		<fieldset>
			...
			<table style="width: 402px;" align="center">
				<tr>
					<td><h:outputText value="Average Daily Hours of Sunlight:"></h:outputText></td>
		...
		<fieldset>
			...
			<table style="width: 402px;" align="center">
				<tr>
					<td><h:outputText value="Energy Used Per Day:"></h:outputText></td>
					<td><h:inputText value="#{location.sunLightHours}"></h:inputText></td>
				</tr>
				<tr>
					<td><h:outputText value="Energy Used Per DayLight Hours:"></h:outputText></td>
					<td><h:inputText value="#{location.sunLightHours}"></h:inputText></td>
				</tr>
			</table>
		</fieldset>
